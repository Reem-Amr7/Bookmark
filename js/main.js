// // إخفاء مربع التنبيه عند تحميل الصفحة
// document.addEventListener("DOMContentLoaded", function () {
//     boxModal.classList.add("d-none"); // إخفاء المربع عند بدء الصفحة
//   });
...
submitBtn.addEventListener("click", function () {
  if (
    ...
    boxModal.style.display = "block"; // إظهار المربع عند الخطأ
  }
});

closeBtn.addEventListener("click", function () {
  boxModal.style.display = "none"; // إخفاء المربع عند إغلاقه
});
